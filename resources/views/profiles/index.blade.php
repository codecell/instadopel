   ...
   <div class="row">
        ...
        <div class="col-9 pt-9">
            ...
            <div class="d-flex">
                ...
                <div class="pr-5">
                    <strong> {{ $user->profile->followers->count() }} </strong> <span>followers</span>
                </div>
                <div class="pr-5">
